...
var G__37594_37631 = static$__$1;
var vec__37595_37632 = G__37594_37631;
var seq__37596_37633 = cljs.core.seq(vec__37595_37632);
var first__37597_37634 = cljs.core.first(seq__37596_37633);
var seq__37596_37635__$1 = cljs.core.next(seq__37596_37633);
var s_37636 = first__37597_37634;
var static_37637__$2 = seq__37596_37635__$1;
var idx_37638 = (0);
var G__37594_37639__$1 = G__37594_37631;
var idx_37640__$1 = idx_37638;
while(true){
var vec__37601_37641 = G__37594_37639__$1;
var seq__37602_37642 = cljs.core.seq(vec__37601_37641);
var first__37603_37643 = cljs.core.first(seq__37602_37642);
var seq__37602_37644__$1 = cljs.core.next(seq__37602_37642);
var s_37645__$1 = first__37603_37643;
var static_37646__$3 = seq__37602_37644__$1;
var idx_37647__$2 = idx_37640__$1;
var cls_37648__$1 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cls),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx_37647__$2)].join('');
cljss.sheet.insert_BANG_(sheet,s_37645__$1,cls_37648__$1);

if(cljs.core.empty_QMARK_(static_37646__$3)){
} else {
var G__37649 = static_37646__$3;
var G__37650 = (idx_37647__$2 + (1));
G__37594_37639__$1 = G__37649;
idx_37640__$1 = G__37650;
continue;
}
break;
}
...
return (function (s,p__37605){
var vec__37606 = p__37605;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37606,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37606,(1),null);
...
var vec__37609 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
...
var first_word = first__37611;
var words = seq__37610__$1;
...
return cljss.core.css(cls,static$,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__37613){
var vec__37614 = p__37613;
var cls__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37614,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37614,(1),null);
...
return (new cljs.core.List(null,cls__$1,(new cljs.core.List(null,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(v,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (vec__37614,cls__$1,v){
return (function (p1__37612_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(props,p1__37612_SHARP_,null);
});})(vec__37614,cls__$1,v))
...
return cljs.core.set(cljs.core.flatten(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.meta,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__37619_SHARP_){
if((!((p1__37619_SHARP_ == null)))){
if((((p1__37619_SHARP_.cljs$lang$protocol_mask$partition0$ & (262144))) || ((cljs.core.PROTOCOL_SENTINEL === p1__37619_SHARP_.cljs$core$IWithMeta$)))){
return true;
} else {
if((!p1__37619_SHARP_.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_(cljs.core.IWithMeta,p1__37619_SHARP_);
} else {
return false;
}
}
...
var k__$1 = (function (){var G__37622 = k;
...
return (function() { 
var G__37669__delegate = function (props,children){
var vec__37628 = ((cljs.core.map_QMARK_(props))?[props,children]:[cljs.core.PersistentArrayMap.EMPTY,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.array,props,children)]);
var props__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37628,(0),null);
var children__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37628,(1),null);
...
var G__37669 = function (props,var_args){
var children = null;
...
while (G__37676__i < G__37676__a.length) {G__37676__a[G__37676__i] = arguments[G__37676__i + 1]; ++G__37676__i;}
  children = new cljs.core.IndexedSeq(G__37676__a,0,null);
} 
return G__37669__delegate.call(this,props,children);};
G__37669.cljs$lang$maxFixedArity = 1;
G__37669.cljs$lang$applyTo = (function (arglist__37677){
var props = cljs.core.first(arglist__37677);
var children = cljs.core.rest(arglist__37677);
return G__37669__delegate(props,children);
});
