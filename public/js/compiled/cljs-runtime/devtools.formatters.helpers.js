...
var G__27576 = devtools.prefs.pref(v);
v = G__27576;
continue;
} else {
return v;
...
}catch (e27505){var _e__26758__auto__ = e27505;
return false;
}})();
...
}catch (e27511){var _e__26758__auto__ = e27511;
return false;
}})();
...
}catch (e27513){var _e__26758__auto__ = e27513;
return false;
}}
}
});
...
var vec__27548 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27548,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27548,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27561_SHARP_);
}),template);
});
