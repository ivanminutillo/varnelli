...
var o26701 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26701["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26702 = temp__5718__auto____$1;
return (o26702["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24800__auto__ = f;
return (o__24800__auto__["toString"]).call(o__24800__auto__);
} else {
return "";
}
}catch (e26704){var _ = e26704;
return "";
}});
...
try{var o__24800__auto___26889 = t;
(o__24800__auto___26889["cljs$lang$ctorPrWriter"]).call(o__24800__auto___26889,t,writer);
}catch (e26707){var __26894 = e26707;
}
...
var char_code = (function (){var o__24800__auto__ = (new String(char$));
return (o__24800__auto__["charCodeAt"]).call(o__24800__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24800__auto__ = String;
return (o__24800__auto__["fromCharCode"]).call(o__24800__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26708 = num_code;
switch (G__26708) {
case (1):
return (185);
...
var o__24800__auto__ = String;
return (o__24800__auto__["fromCharCode"]).call(o__24800__auto__,superscript_code);
});
/**
...
}catch (e26710){var _e__24808__auto__ = e26710;
return false;
}})())){
...
var vec__26711 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26711,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o26715 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26715["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26716 = temp__5718__auto____$1;
return (o26716["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26719){
var vec__26720 = p__26719;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26720,(0),null);
...
var G__26936 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__26937 = cljs.core.butlast(remaining_tokens);
name_tokens = G__26936;
remaining_tokens = G__26937;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26717){
...
var vec__26725 = cljs.core.split_with((function (p1__26724_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__26724_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26725,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26725,(1),null);
...
var vec__26733 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26733,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26733,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__26945 = cljs.core.rest(remaining_tokens);
var G__26946 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__26945;
name_tokens = G__26946;
continue;
} else {
...
var vec__26741 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26741,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26741,(1),null);
var vec__26744 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26744,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26744,(1),null);
var vec__26747 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26747,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26747,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26747,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26747,(3),null);
...
var vec__26757 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26757,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26757,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26757,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26757,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26757,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26757,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__26761 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26761,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26761,(1),null);
var vec__26764 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26764,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26764,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__26767 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__26767) : devtools.munging.parse_fn_info_deep.call(null,G__26767));
})()));
}
} else {
return fn_info;
...
var G__26960 = (arity + (1));
var G__26961 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26770){
var vec__26771 = p__26770;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26771,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26771,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__26775_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__26776_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___26964 = arguments.length;
var i__4731__auto___26965 = (0);
while(true){
if((i__4731__auto___26965 < len__4730__auto___26964)){
args__4736__auto__.push((arguments[i__4731__auto___26965]));

var G__26966 = (i__4731__auto___26965 + (1));
i__4731__auto___26965 = G__26966;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26779){
var vec__26780 = p__26779;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26780,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26777){
var G__26778 = cljs.core.first(seq26777);
var seq26777__$1 = cljs.core.next(seq26777);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26778,seq26777__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26803__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26803__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26803__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26803__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26804 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26804,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26804,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26804,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26804,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26804,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26804,(5),null);
...
var o__24800__auto__ = f;
return (o__24800__auto__["getBasis"]).call(o__24800__auto__);
});
/**
...
}catch (e26820){var _e__24808__auto__ = e26820;
...
var G__26993 = (obj[cljs.core.first(path)]);
var G__26994 = cljs.core.rest(path);
obj = G__26993;
path = G__26994;
continue;
} else {
...
return (function (accum,p__26864){
var vec__26865 = p__26864;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26865,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26865,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26870){
var vec__26871 = p__26870;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26871,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26871,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26871,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26883,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26883,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__26883,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26878_SHARP_){
return (obj[cljs.core.first(p1__26878_SHARP_)]);
});})(name,sorted_matches,vec__26883,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
