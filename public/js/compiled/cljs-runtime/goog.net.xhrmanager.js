...
goog.net.XhrManager = function(opt_maxRetries, opt_headers, opt_minCount, opt_maxCount, opt_timeoutInterval, opt_withCredentials) {
  ...
  /** @private @type {number} */ this.maxRetries_ = goog.isDef(opt_maxRetries) ? opt_maxRetries : 1;
  /** @private @type {number} */ this.timeoutInterval_ = goog.isDef(opt_timeoutInterval) ? Math.max(0, opt_timeoutInterval) : 0;
